...
class BertEncoder(nn.Module):
    def __init__(self, cfg):
        ...
        if self.bert_name == "bert-base-uncased":
            ...
            config = BertConfig.from_pretrained(BERT_LOCAL_PATH_Conf, local_files_only=True)
            ...
            self.model = BertModel.from_pretrained(BERT_LOCAL_PATH_Model, add_pooling_layer=False, config=config, local_files_only=True)
